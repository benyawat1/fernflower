...
import org.jetbrains.java.decompiler.main.rels.NestedClasrocessor;
...
public class Classerocessor {
  ...
  public Classerocessor(StructContext context) {
  ...
  public void writeClass(StructClass cl, TextBuffer buffer) throws IOException {
    ...
    try {
      ...
      if (packageInfo) {
        ...
        new NestedClasrocessor().processClass(root, root);
  ...
  public static class ClassNode implements Comparable<ClassNode> {
    ...
    public final Map<String, VarVersion> mapFieldsToVars = new HashMap<>();
